...
function AddItem() {
  ...
  return (
    ...
    <Flex justify="center" align='center'  className="gridentBG"   bgGradient="linear-gradient(90deg, blue.600 0%, blue.500 35%, blue.400 100%)"
    > 
    ...
    {step == 1 &&
    <>
    <Text bg='black' opacity='0.9' color='white' p='10px' fontSize={{base:'14px', md:'20px', lg:'24px'}} borderRadius='8px' >What do you want to sell?</Text>
        ...
        <GridItem >
          <form onSubmit={(e) => handleChange(e)}>
            ...
            <Box
              ...
              >
          <Text bg='black' opacity='0.9' p='2px' borderRadius="lg" key={index} w={{ base: "65px", md: "100px", lg: "200px" }} fontSize = {{ base: "10px", md: "16px", lg: "20px" }}
